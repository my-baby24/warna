    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>Useful Links</h4>
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('wlcm') }}">Beranda</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="{{ route('about.index') }}">Tentang</a></li>
        ...
        <div class="col-lg-3 col-md-6 footer-info">
          <h3>Tentang Warna</h3>
          <p>Web Informasi Sarana dan Prasarana (WARNA) adalah aplikasi Monitoring untuk Engagement Peserta selama mengikuti pembelajaran di <b>PLN UPDL Padang</b></p>
