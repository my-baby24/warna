  ...
  <div id="hehe" class="carousel slide card" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset('kuliner/images/data-wisata/Istano Basa Pagaruyung/m.jpg') }}" class="d-block w-100" alt="Wisata 1">
      </div>

      <div class="carousel-item">
        <img src="{{ asset('kuliner/images/data-wisata/Istano Basa Pagaruyung/n.jpg') }}" class="d-block w-100" alt="Wisata 2">
      </div>

      <div class="carousel-item">
        <img src="{{ asset('kuliner/images/data-wisata/Istano Basa Pagaruyung/o.jpg') }}" class="d-block w-100" alt="Wisata 3">
      </div>
    </div>
...
<div id="info" class="card">
  <h2>Istano Basa Pagaruyung</h2>
  <p><strong><i class="fas fa-map-marker-alt"></i></i> Alamat :</strong> Jl. Sutan Alam Bagagarsyah, Pagaruyung, Kec. Tj. Emas, Kabupaten Tanah Datar, Sumatera Barat.</p>
  <p><strong><i class="fas fa-location-arrow"></i> Jarak :</strong> 63,1 KM</p>
  ...
  <span id="showDescription" onclick="openDescriptionModal()">Lihat Deskripsi</span></p>
...
<div id="descriptionModal">
  <div id="descriptionContent">
    ...
    <p>Danau Maninjau merupakan sebuah danau vulkanik yang berada tepat di jantung Kabupaten Agam, Sumatera Barat. Terletak di ketinggian kurang lebih 460 meter di atas permukaan laut, danau ini membentang seluas 100 km persegi dengan kedalaman rata-rata 105 meter. ...</p>
  </div>
</div>
