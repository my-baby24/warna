  ...
  <div id="hehe" class="carousel slide card" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="{{ asset('kuliner/images/data-wisata/danau singkarak/m.jpg') }}" class="d-block w-100" alt="Wisata 1">
      </div>

      <div class="carousel-item">
        <img src="{{ asset('kuliner/images/data-wisata/danau singkarak/n.jpg') }}" class="d-block w-100" alt="Wisata 2">
      </div>

      <div class="carousel-item">
        <img src="{{ asset('kuliner/images/data-wisata/danau singkarak/o.jpg') }}" class="d-block w-100" alt="Wisata 3">
      </div>
    </div>
...
<div id="info" class="card">
  ...
  <p><strong><i class="fas fa-map-marker-alt"></i></i> Alamat :</strong> Kec. X Koto Singkarak, Kabupaten Solok, Sumatera Barat.</p>
